...
фильмах, их просмотрах и пользователях.
...
На рисунке представлена даталогическая модель базы данных.
